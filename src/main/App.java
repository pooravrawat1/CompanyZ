...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		switch (loginChoice) {
			...
			case 2 -> employeeSearch(); //@ Shelden implement user auth for employees
		}
	...
	public static void employeeChoice() throws SQLException {
		System.out.println(ANSI.GREEN + "\nWOULD YOU LIKE TO SEARCH AGAIN, OR QUIT?\n" + ANSI.RESET + queryDecorator + "\n+ SEARCH AGAIN - ENTER 1\n+ QUIT - ENTER 2 \n\nENTER COMMAND: ");	
		Scanner scn = new Scanner(System.in);
